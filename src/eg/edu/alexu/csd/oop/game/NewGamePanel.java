...
public class NewGamePanel extends JPanel {
	...
	/** items of comboBox */
	private final String[] items = {"Level1", "Level2", "Level3", "Level4", "Level5"};
	...
	private void setDoneSettings() {
		...
		this.startGame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				selectedLevel = (String)levels.getSelectedItem();
				player = player_name.getText();
				if(player.equals("") || player.equals(TEXT)) {
					player_name.setBackground(Color.RED);
					player_name.setText("Please Enter Your Name");
